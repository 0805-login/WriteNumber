...
public class OneActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_number);//设置数字1功能界面布局文件
    ...
    public void Show(View v) {  	// 创建演示按钮，单击事件方法
        if (dialog == null) {  	// 如果自定义对话框为空
            ...
            dialog = new ProgressDialog(this, "点击边缘取消", R.drawable.frame1);
        }
        dialog.show();   		// 显示对话框
    }
    ...
    //数字1书写界面清空所占内存资源时，背景音乐停止并清空音乐资源所占的内存
    @Override
