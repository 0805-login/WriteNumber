...
public class FiveActivity extends Activity {
    ...
    public void Show(View v) {    // 创建演示按钮，单击事件方法
        if (dialog == null) {    // 如果自定义对话框为空
            ...
            dialog = new ProgressDialog(this, "点击边缘取消", R.drawable.frame5);
        }
        dialog.show();        // 显示对话框
    }
    ...
    protected void dialog() {//完成后提示对话框头部
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(com.example.writenumber.FiveActivity.this);
